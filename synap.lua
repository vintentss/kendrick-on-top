...
execute.MouseButton1Click:Connect(function()
    ...
    if injected == false then
        title.Text = "Synaptics - BETA (not injected! press attach)"
    end
end)
...
Attach.MouseButton1Click:Connect(function()
    print("hi")
    if injected == true then
        title.Text = "Synaptics - BETA (already injected!)"
        wait(1)
        title.Text = "Synaptics - BETA"
    end
    if injected == false then
        title.Text = "Synaptics - BETA (checking...)"
        wait(0.1)
        title.Text = "Synaptics - BETA (injecting...)"
        wait(1.5)
        setfpscap(1)
        wait(1)
        setfpscap(6969)
        title.Text = "Synaptics - BETA (checking whitelist...)"
        wait(0.8)
        title.Text = "Synaptics - BETA (scanning...)"
        wait(0.3)
        title.Text = "Synaptics - BETA (ready!)"
        wait(0.5)
        title.Text = "Synaptics - BETA"
        injected = true
    end
...
execute_2.MouseButton1Click:Connect(function()
    if injected == true then
        ...
        if scriptselected == "dumper" then
            warn("Dumper doesn't work as of now.")
        end
...
while true do
    ...
    if scripthub_2.Visible == true then
        ...
        if scriptselected == "dex" then
            descri.Text = "A version of the popular Dex explorer with patches specifically for Synapse when it existed.."
        end
        if scriptselected == "esp" then
